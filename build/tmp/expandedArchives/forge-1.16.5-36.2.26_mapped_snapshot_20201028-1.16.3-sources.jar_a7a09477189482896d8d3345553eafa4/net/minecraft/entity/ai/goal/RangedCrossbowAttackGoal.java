   ...
   public void tick() {
      ...
      if (livingentity != null) {
         ...
         if (this.field_220749_b == RangedCrossbowAttackGoal.CrossbowState.UNCHARGED) {
            if (!flag2) {
               this.field_220748_a.setActiveHand(ProjectileHelper.getWeaponHoldingHand(this.field_220748_a, item -> item instanceof CrossbowItem));
            ...
            ItemStack itemstack1 = this.field_220748_a.getHeldItem(ProjectileHelper.getWeaponHoldingHand(this.field_220748_a, item -> item instanceof CrossbowItem));
