...
import net.mcreator.wargle.network.BlueprintMakerGUISlotMessage;
...
public class BlueprintMakerGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public BlueprintMakerGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(WargleModMenus.BLUEPRINT_MAKER_GUI.get(), id);
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			WargleMod.PACKET_HANDLER.sendToServer(new BlueprintMakerGUISlotMessage(slotid, x, y, z, ctype, meta));
			BlueprintMakerGUISlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
